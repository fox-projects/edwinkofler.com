...
test("transformUri", () => {
  ...
  assert.equal(
    transformUri(
      "posts/2018/hugo-render-latex-with-katex/hugo-render-latex-with-katex.md",
    ),
    "posts/render-latex-with-katex-in-hugo-blog/render-latex-with-katex-in-hugo-blog.md",
  );
  assert.equal(
    transformUri(
      "posts/2018/fibonacci-pascal-equation-part-1/fibonacci-pascal-equation-part-1.md",
    ),
